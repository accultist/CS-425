...
//
const uint16_t DefaultPort = 8106; // Update this variable with your assigned port value
                                   // edit: 8106 was my personally assigned port

// void handleSessions (struct)
// for the purposes of handling creating multi-threading applications
...
void handleSession(Session session) {
    ...
    // source of local files hosted on blue server ("/home/faculty/shreiner/public_html/03")
...
int main(int argc, char* argv[]) {
    ...
    while (connection) {
        ...
        //
        // each iteration will accept a connection (like before in the original program)
